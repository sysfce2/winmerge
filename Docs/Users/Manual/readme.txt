...
2006-07-16 Tim
 ...
 PATCH: [ 1523188 ] Manual: Use 'simpara' instead 'para' for language name list
  Manual: Locales.xml
...
2006-06-02 Tim
 ...
 Fix error in build script for htmlhelp. WinMerge 2.4 use still PNG files for admon graphics.
...
2006-02-28 Kimmo
 ...
 PATCH: [ 1440435 ] Manual: add FAQ item about hiding similar lines in editor
  Manual: Faq.xml
 Bump version number to 1.1.8 and copyright years to 2004-2006
  Manual: WinMerge_help.xml
...
2006-02-14 Tim
 PATCH: [ 1431053 ] Manual: Remove echo off/on from configuration.bat (XSL)
  Manual/build: configuration.bat

2006-02-12 Kimmo
 BUG: [ 1412404 ] Manual example looks wrong
  Manual: Quick_start.xml

2006-02-12 Tim
 BUG: [ 1428754 ] HTML Help build broken?
  Manual/build: build_htmlhelp.bat

2006-01-27 Tim
 TODO: [ 1413926 ] Build manual file(s) to /Build
  Manual/build: configuration.bat

2006-01-26 Tim
 PATCH: [ 1414983 ] Manual: Make build path configurable (XSL)
  Manual/build: build_html.bat build_htmlhelp.bat configuration.bat

2006-01-26 Kimmo
 PATCH: [ 1412405 ] Some edits to About & QuickStart pages of manual
  Submitted by Perry
  Manual: About_Doc.xml Quick_start.xml

2006-01-21 Kimmo
 PATCH: [ 1407555 ] Manual: add new shortcuts for find
  Manual: Shortcut_keys.xml

2006-01-08 Perry
 BUG: [ 1396950 ] Manual installation doesn't specify admin access
  Manual: Install.xml
...
2005-12-20 Kimmo
 PATCH: [ 1384834 ] Copyedited FAQ
  Submitted by Perry, small edits for 2.4 branch by me
  Manual: Faq.xml
...
2005-12-15 Kimmo
 Bump revision to 1.1.7
  Manual: WinMerge_help.xml

2005-12-09 Kimmo
 PATCH: [ 1375564 ] New encoding FAQ (UTF-8)
  Submitted by Perry
  Manual: Faq.xml

2005-11-10 Kimmo
 Bump revision to 1.1.6
  Manual: WinMerge_help.xml

2005-11-09 Kimmo
 PATCH: [ 1351769 ] Manual: Minor update to file compare chapter
  Manual: Compare_files.xml

2005-11-08 Kimmo
 PATCH: [ 1350794 ] Manual: Update About doc chapter
  Manual: About_Doc.xml
 PATCH: [ 1350819 ] Manual: Small improvements for folder compare
  Manual: Compare_dirs.xml

2005-11-01 Kimmo
 PATCH: [ 1344213 ] Manual: typo fixes for Configuration part
  Manual: Configuration.xml
 PATCH: [ 1344219 ] Manual: New FAQ items about archive files detection
  Manual: Faq.xml

2005-10-29 Kimmo
 PATCH: [ 1341076 ] Manual: Mention maximum linefilter length
  Manual: Filters.xml

2005-10-21 Kimmo
 PATCH: [ 1329867 ] Manual: Improve Binary file FAQ
  Manual: Faq.xml

2005-09-20 Kimmo
 PATCH: [ 1295568 ] Manual: New Open-dialog screenshot
  Manual/screenshots: OpenDlg1.gif
 PATCH: [ 1295601 ] Manual: Add linediff coloring
  Manual: Compare_files.xml
  Manual/screenshots new file: filecomp_inlinediff.gif
 PATCH: [ 1295612 ] Manual: add tip for eols and linefilters
  Manual: Filters.xml
 Update winMerge version to 2.4
  Manual: About_doc.xml WinMerge_help.xml

2005-09-19 Kimmo
 PATCH: [ 1294595 ] Manual: Update options
  Manual: Configuration.xml

2005-09-18 Kimmo
 PATCH: [ 1294162 ] Manual: First update to file compare
  Manual: Compare_filex.xml
  Manual/Screenshots: filecomp1.gif filecomp_context1.gif filecomp_statusbar1.gif
   linediff.gif
  Manual/Screenshots new files: File_headerbar1.gif Merge_menu.gif
  Manual/Screenshots deleted files File_headerbar1.jpg Merge_menu.jpg

2005-09-17 Kimmo
 PATCH: [ 1293296 ] Manual: Updates for folder compare
  Manual: Compare_dirs.xml
...
2005-09-16 Kimmo
 ...
 PATCH: [ 1292336 ] Manual: update installation doc
  Manual: Install.xml Introduction.xml
